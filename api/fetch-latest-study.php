...
function debugLog($message) {
    $logFile = 'C:/xampp/htdocs/projet-medical/logs/debug_fetch_study.log';
...
$pattern = '#^/projet-medical/api/fetch-latest-study/(\d+)$#';
...
// Fetch the most recent StudyInstanceUID for the patient
try {
    $stmt = $pdo->prepare('SELECT description FROM dicom Continues_instances WHERE patient_id = ? ORDER BY upload_date DESC LIMIT 1');
